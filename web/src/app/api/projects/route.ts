...
function mapSupabaseToProject(data: any[]): Project[] {
  return data.map((item) => ({
    ...
    cover_image: item.cover_image || item.image_url || 'https://images.unsplash.com/photo-1563770660941-20978e770fa3?auto=format&fit=crop&w=1200&q=80',
    project_images: Array.isArray(item.project_images) && item.project_images.length > 0 ? item.project_images : [item.cover_image || item.image_url || 'https://images.unsplash.com/photo-1563770660941-20978e770fa3?auto=format&fit=crop&w=1200&q=80'],
...
export async function POST(req: Request) {
  try {
    ...
    const dbPayload = {
      ...
      image_url: cover_image || imagesList[0] || 'https://images.unsplash.com/photo-1563770660941-20978e770fa3?auto=format&fit=crop&w=1200&q=80',
      cover_image: cover_image || imagesList[0] || 'https://images.unsplash.com/photo-1563770660941-20978e770fa3?auto=format&fit=crop&w=1200&q=80',
